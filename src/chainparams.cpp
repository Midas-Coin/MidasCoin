...
public:
    CMainParams() {
        ...
        const char* pszTimestamp = "MidasCoin begins";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
...
////////
        ...
        vSeeds.push_back(CDNSSeedData("node.MidasCoin.org", "node.MidasCoin.org"));
        vSeeds.push_back(CDNSSeedData("node.MidasCoin.cf", "node.MidasCoin.cf"));
        vSeeds.push_back(CDNSSeedData("MidasCoin.no-ip.org", "MidasCoin.no-ip.org"));
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        // vSeeds.push_back(CDNSSeedData("MidasCoin.test", "test.MidasCoin.org"));
