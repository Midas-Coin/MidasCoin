...
std::string HelpMessage()
{
    ...
    strUsage += "  -conf=<file>           " + _("Specify configuration file (default: MidasCoin.conf)") + "\n";
    strUsage += "  -pid=<file>            " + _("Specify pid file (default: MidasCoind.pid)") + "\n";
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    // As the promidas has not fully started yet, Shutdown() is possibly overkill.
    if (fRequestShutdown)
    {
